...
public final class Landscape {
    ...
    public static final int DEFAULT_LANDSCAPE_SEED = 1;
    ...
    /**
     * Paired diffuse and normal map layers for a terrain structure or texture layer.
     */
    ...
    public Landscape(int num_players, IslandConfig config, float detail_alpha_value,
        ...
        this.sea_level_meters = height_scale * SimulationConfig.SEA_LEVEL;
    ...
    private void generateSupplies(Channel grass_alpha) {
        ...
        plantsmap.channelMultiply(height.copy().threshold(SimulationConfig.SEA_LEVEL, 1f));
