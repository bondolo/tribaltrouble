...
public final class Cellular {
    /**
     * Hitpoint distribution patterns for cellular feature generation.
     */
    ...
    /**
     * Distance metric functions used to evaluate proximity to feature points.
     */
    public enum Metric {
        NORMAL,
        OVAL,
    ...
    /**
     * Feature value evaluation modes computed per cell pixel.
     */
    public enum Value {
        DISTANCE,
        HITPOINT,
