...
/** Campaign level setup for Viking Island 9. */
final class VikingIsland9 extends Island {
    ...
    VikingIsland9(Campaign campaign) {
        super(campaign);
    }
    ...
    public void init(GUIRoot gui_root) {
        ...
        GameNetwork game_network = startNewGame(gui_root, 256, Terrain.NATIVE, 1f, .85f, .85f,
