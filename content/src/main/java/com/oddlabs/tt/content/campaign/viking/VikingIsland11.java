...
/** Campaign level setup for Viking Island 11. */
final class VikingIsland11 extends Island {
    ...
    VikingIsland11(Campaign campaign) {
        super(campaign);
    }
    ...
    public void init(GUIRoot gui_root) {
        ...
        GameNetwork game_network = startNewGame(gui_root, 256, Terrain.NATIVE, .75f, 1f, .85f,
