...
public final strictfp class NativeIsland3 extends Island {
	...
	protected void start() {
		...
		new SceneryModel(getViewer().getWorld(), thor_x, thor_y, dir, dir, enemy.getRace().getUnitTemplate(Race.UnitType.CHIEFTAIN).getSpriteRenderer(), shadow_diameter, true, Utils.getBundleString(bundle, "god"), Unit.ANIMATION_THOR, -1f, 0f);


		// Insert reinforcements
		reinforcements.setStartX(126*2);
		reinforcements.setStartY(135*2);
		reinforcements.buildBuilding(Race.BuildingType.QUARTERS, 96, 145);
		reinforcements.buildBuilding(Race.BuildingType.ARMORY, 126, 135);
		for (int i = 0; i < 30; i++) {
			new Unit(reinforcements, 126*2, 135*2, null, reinforcements.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		}

		// Insert native towers
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 60, 60);//*
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 110, 167);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 102, 127);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 67, 163);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 71, 189);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 92, 205);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 128, 186);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 191, 185);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 145, 128);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 173, 90);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 161, 82);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 120, 140);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 124, 127);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 135, 140);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 100, 139);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 80, 97);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 112, 76);

		// Scattered resistance
		new Unit(enemy, 180*2, 155*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 178*2, 145*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		new Unit(enemy, 178*2, 151*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 180*2, 153*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		new Unit(enemy, 103*2, 93*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 99*2, 99*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		new Unit(enemy, 113*2, 98*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 116*2, 98*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		new Unit(enemy, 83*2, 170*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 110*2, 199*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		new Unit(enemy, 186*2, 215*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 186*2, 211*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		new Unit(enemy, 53*2, 105*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 51*2, 107*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
		new Unit(enemy, 53*2, 110*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_ROCK));
		new Unit(enemy, 53*2, 101*2, null, enemy.getRace().getUnitTemplate(Race.UnitType.WARRIOR_IRON));
