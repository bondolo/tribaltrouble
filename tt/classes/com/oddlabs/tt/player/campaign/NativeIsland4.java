...
public final strictfp class NativeIsland4 extends Island {
	...
	protected void start() {
		...
		for (int i = 0; i < 10; i++) {
            new Unit(captives, captive_x*2, captive_y*2, null, captives.getRace().getUnitTemplate(Race.UnitType.PEON));
        }
...
*/
		...
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 125, 161);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 125, 150);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 136, 153);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 180, 184);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 158, 154);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 163, 177);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 173, 175);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 165, 167);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 104, 192);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 108, 185);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 103, 210);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 115, 205);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 155, 185);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 145, 171);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 108, 150);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER, 130, 189);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER,  82, 170);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_RUBBER,  65, 167);
