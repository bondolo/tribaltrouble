...
public final strictfp class VikingIsland9 extends Island {
	...
	protected void start() {
		...
		chief_tribe.setActiveChieftain(new Unit(chief_tribe, 56*2, 110*2, null, chief_tribe.getRace().getUnitTemplate(Race.UnitType.CHIEFTAIN)));
		...
		// Towers
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 50, 85);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 52, 81);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 54, 96);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 61, 104);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 57, 104);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 78, 90);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 72, 88);
		insertGuardTower(enemy, Race.UnitType.WARRIOR_IRON, 71, 83);
