 ...
 * ticks managed via {@link com.oddlabs.tt.base.event.LocalEventQueue#getManager()} for lockstep multiplayer state,
 ...
 * {@link com.oddlabs.tt.base.event.LocalEventQueue#getHighPrecisionManager()} for camera interpolation, particle
