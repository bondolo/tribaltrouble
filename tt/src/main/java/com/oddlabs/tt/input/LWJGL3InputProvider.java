    ...
    public void processEvent(@NonNull SDL_Event event) {
        switch (event.type()) {
            ...
            case SDL_EVENT_TEXT_INPUT -> {
                // SDL 3 text input gives a string. We only need the first codepoint for now?
                // Or we should handle it better.
            ...
            case SDL_EVENT_MOUSE_MOTION -> {
                ...
                this.mouseY = window.getLogicalHeight() - motionEvent.y() - 1;
            ...
            case SDL_EVENT_MOUSE_BUTTON_DOWN, SDL_EVENT_MOUSE_BUTTON_UP -> {
                ...
                synchronized (mouseEvents) {
                    mouseEvents.add(new MouseEvent(button, pressed, (int) mouseX, (int) mouseY, 0));
                }
            }
