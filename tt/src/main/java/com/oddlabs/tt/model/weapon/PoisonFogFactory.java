...
public final class PoisonFogFactory implements MagicFactory {
    ...
    public PoisonFogFactory(float offset_x, float offset_y, float offset_z, float hit_radius, float hit_chance,
            float interval, float time, int damage, float seconds_per_anim, float init_ratio, float release_ratio) {
