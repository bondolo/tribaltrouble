...
public final class RockAxeWeapon extends RotatingThrowingWeapon {
    ...
    public RockAxeWeapon(boolean hit, @NonNull Unit src, @NonNull Selectable<?> target, @NonNull SpriteKey sprite_renderer, @NonNull AudioFile throw_sound, @NonNull AudioFile @NonNull [] hit_sounds) {
